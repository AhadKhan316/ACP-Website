  ...
  return (
    <section className="py-24 px-4 md:px-8 bg-navy-800 text-ivory-100 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-red-800 text-center">
          Subscribe to Our Newsletter
        </h2>
        <p className="text-lg md:text-xl font-sans mb-8">
          Stay updated with the latest news and events from PLF.
        </p>
        <form className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
          <input
            type="email"
            placeholder="Enter your email"
            className="w-full sm:w-64 p-3 rounded-lg bg-navy-800/50 backdrop-blur-md text-ivory-100 border border-navy-700 focus:outline-none focus:ring-2 focus:ring-red-900 transition duration-300"
          />
          <button
            type="submit"
            className="bg-red-800 text-white font-sans font-semibold py-3 px-6 rounded-lg hover:bg-red-800 transition duration-300"
          >
            Subscribe
          </button>
        </form>
