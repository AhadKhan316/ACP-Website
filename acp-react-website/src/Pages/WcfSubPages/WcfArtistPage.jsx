...
import CardDisplay from "../../components/wcfReusableComponents/WcfLandingPageCardCarousel"; // Adjust the import path as needed

const WcfArtists = () => {
  const artists = [
    { id: 1, name: "Aashir Wajahat", image: "/src/assets/wcf-assets/aashir-wajat-artist.jpg", country: "Pakistan" },
    { id: 2, name: "Abdul Hannan", image: "/placeholder-artist2.jpg", country: "Pakistan" },
    { id: 3, name: "Abdur Rahman Sajid", image: "/placeholder-artist3.jpg", country: "Pakistan" },
    { id: 4, name: "Acma The Band", image: "/src/assets/wcf-assets/ACMA2-artist.jpg", country: "Pakistan" },
    ...
    { id: 7, name: "Alex Liu", image: "/placeholder-artist7.jpg", country: "Spain" },
    { id: 8, name: "Ali Mohammad Roonjho & Sattar Jogi", image: "/placeholder-artist8.jpg", country: "Pakistan" },
    ...
    { id: 11, name: "Bhawani Karki", image: "/placeholder-artist11.jpg", country: "Nepal" },
    { id: 12, name: "Chris Kelly", image: "/placeholder-artist12.jpg", country: "Spain" },
    { id: 13, name: "Cosmic Fluid", image: "/placeholder-artist13.jpg", country: "Pakistan" },
    { id: 14, name: "Daniele Fabio", image: "/placeholder-artist14.jpg", country: "Italy" },
    { id: 15, name: "Daryl Giullano", image: "/placeholder-artist15.jpg", country: "Canada" },
    ...
    { id: 18, name: "Erica Lauren", image: "/placeholder-artist18.jpg", country: "Spain" },
    ...
    { id: 27, name: "Jihadi Urbansong", image: "/placeholder-artist27.jpg", country: "Rwanda" },
    ...
    { id: 32, name: "Luise Volkmann", image: "/placeholder-artist32.jpg", country: "Germany" },
    ...
    { id: 36, name: "Max Andrzejewski", image: "/placeholder-artist36.jpg", country: "Germany" },
    ...
    { id: 40, name: "Natalia Gul", image: "/placeholder-artist40.jpg", country: "Pakistan" },
