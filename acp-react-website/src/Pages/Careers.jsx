  ...
  return (
    <div className="py-10 bg-[#0F172A] text-white flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full mx-4 bg-[#1E293B] rounded-3xl shadow-2xl p-6 sm:p-8 mb-12 overflow-hidden relative">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-white text-center mb-4 relative z-10">
          Join ACP Team
        </h1>
        {/* <a
          href="#apply"
      ...
      {/* Introduction */}
      <div className="w-full max-w-3xl text-gray-300 text-center mb-12">
      ...
      <div className="w-full max-w-3xl mb-12">
        <h2 className="text-2xl sm:text-3xl font-semibold text-[#F5F1E1] text-center mb-6">
          Open Job Vacancies
        </h2>
      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="space-y-6">
          {/* Example Previous Vacancy Card (Add more as needed) */}
          <div className="bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row items-center gap-6 mb-4">
              <img
                src="https://acpkhi.com/logo.png" // Use the logo or a placeholder
                alt="ACP Logo"
